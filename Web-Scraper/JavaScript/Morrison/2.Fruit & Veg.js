...
(async function main() {
    try{
        ...
        await page.goto('https://groceries.morrisons.com/browse/fruit-veg-176738');
        ...
        for (let i = 0; i < Cat_container.length; i++) {
            ...
            Folder_path = `${Folder+Folder_cat[1]}/${Folder_cat[2]}/`;
        ...
        async function aisle_slct() {
            ...
            if(await page.$('div.grocery-section.level-0')) {
                ...
                for(let i = 0; i < Aisle_cat_btn.length; i++) {
                    ...
                    File_path = `${Folder_path+File_name[i].trim()}.csv`;
